    ...
    <div style={{minHeight:"100vh",background:"#f0f2f5"}}>
      ...
      <div style={{background:"#fff",padding:"10px 16px",borderBottom:"1px solid #eee",
        ...
        <div style={{display:"flex",gap:8,flexWrap:"wrap",alignItems:"center",marginBottom:8}}>
          <input placeholder={t.from} autoComplete="off" style={{flex:"1 1 120px",minWidth:0,border:"1.5px solid #e0e0e0",borderRadius:8,padding:"7px 10px",fontSize:13,color:"#333",background:"#fff",outline:"none"}}/>
          <input placeholder={t.to}   autoComplete="off" style={{flex:"1 1 120px",minWidth:0,border:"1.5px solid #e0e0e0",borderRadius:8,padding:"7px 10px",fontSize:13,color:"#333",background:"#fff",outline:"none"}}/>
            ...
            <div style={{display:"flex",flexDirection:"column",gap:10}}>
              <div style={{display:"flex",gap:8}}>
                <input value={fFrom} onChange={e=>setFFrom(e.target.value)}
                  placeholder="Откуда (город)" autoComplete="off" style={inputStyle}/>
                <input value={fTo} onChange={e=>setFTo(e.target.value)}
                  placeholder="Куда (город)" autoComplete="off" style={inputStyle}/>
              </div>
